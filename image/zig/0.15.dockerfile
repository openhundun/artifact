...
ARG TARGETARCH
ARG ZIG_URL_AMD64="https://ziglang.org/download/0.15.2/zig-x86_64-linux-0.15.2.tar.xz"
ARG ZIG_URL_ARM64="https://ziglang.org/download/0.15.2/zig-aarch64-linux-0.15.2.tar.xz"
RUN \
